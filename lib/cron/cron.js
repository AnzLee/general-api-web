...
function submit(){
    ...
    var inputid = url.split('#')[1].split('&')[0];
    window.parent.cronInput(inputid, $("#cron").val());
...
$(function() {
    ...
    var url=window.location.href;
    var inputcron = url.split('#')[1].split('&')[1];
    //'选择运行时间'的url转码%E9%80%89%E6%8B%A9%E8%BF%90%E8%A1%8C%E6%97%B6%E9%97%B4
    if('%E9%80%89%E6%8B%A9%E8%BF%90%E8%A1%8C%E6%97%B6%E9%97%B4'!=inputcron){
        $('#cron').val(inputcron);
        btnFan();
	}
});